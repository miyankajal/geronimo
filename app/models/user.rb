class User < ActiveRecord::Base
	...
	validates_presence_of :username, :email, :password_digest, :first_name, :last_name, :enrollment_id
	#validates_presence_of :class_id, :if => (:type == 3) #should have a class_id only if the user is a student 
